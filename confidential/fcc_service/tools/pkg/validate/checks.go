...
func RegisterRegistrationChecks(
	...
	RegisterRegistrationChecksFiltered(
		r,
		client,
		key,
		registry,
...
func RegisterRegistrationChecksFiltered(
	r *Report,
	client *ethclient.Client,
	key *ecdsa.PrivateKey,
	registry *extensionmanager.ExtensionManager,
	...
	if shouldRun("R2") && registry != nil && client != nil && addressRegex.MatchString(instrSender) {
	...
	if shouldRun("R3") && key != nil && allowlist != nil && client != nil {
	...
	if shouldRun("R4") && registry != nil && client != nil {
	...
	if shouldRun("R7") && counter != nil && counter.Sign() > 0 && addressRegex.MatchString(instrSender) && registry != nil && client != nil {
		expectedAddr := common.HexToAddress(instrSender)
